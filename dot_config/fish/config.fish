if status is-interactive
    ...
    alias fix-headset="systemctl --user restart wireplumber pipewire-pulse pipewire && sleep 3 && pactl set-default-sink alsa_output.usb-Logitech_Logitech_Wireless_Headset_88C626D5E708-00.playback.0.0"
    alias fj fastfetch
    alias t "ttyper -w 10"
